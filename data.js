const foodData = [
  ...
  {
    id: 's12_1',
    name: 'Вафля классическая / Артек (1 шт = ~19г угл)',
    category: 'Сладости',
    carbsPer100g: 1900,
    unit: 'pcs',
    gi: 'high',
  ...
  {
    id: 's12_2',
    name: 'Вафля венская / мягкая (1 шт = ~25г угл)',
    category: 'Сладости',
    carbsPer100g: 2500,
    unit: 'pcs',
    gi: 'high',
  ...
  {
    id: 's12_3',
    name: 'Вафля в шоколадной глазури (1 шт = ~15г угл)',
    category: 'Сладости',
    carbsPer100g: 1500,
    unit: 'pcs',
    gi: 'high',
  ...
  {
    id: 'dr_comp_2',
    name: 'Компот из сухофруктов / узвар',
    category: 'Напитки',
    carbsPer100g: 3.5,
    gi: 'medium',
    unit: 'ml',
  ...
  {
    id: 'dr_nrg_1',
    name: 'Энергетик с сахаром (Red Bull, Monster, Burn)',
    category: 'Напитки',
    carbsPer100g: 11,
    gi: 'high',
    unit: 'ml',
  ...
  {
    id: 'dr_nrg_zero',
    name: 'Энергетик БЕЗ сахара (Zero / Ultra)',
    category: 'Напитки',
    carbsPer100g: 0,
    gi: 'low',
    unit: 'ml',
  ...
  {
    id: 'dr9',
    name: 'Капучино (стандартная порция)',
    category: 'Напитки',
    carbsPer100g: 4,
    gi: 'low',
  },
  ...
  {
    id: 'side_pot_1',
    name: 'Картофельное пюре (с молоком/маслом)',
    category: 'Гарниры',
    carbsPer100g: 16,
    gi: 'medium',
    defaultAmount: 150,
  ...
  {
    id: 'side_pot_2',
    name: 'Картофель вареный (целиком)',
    category: 'Гарниры',
    carbsPer100g: 17,
    gi: 'medium',
    defaultAmount: 150,
  ...
  {
    id: 'meat_cut_1',
    name: 'Котлета мясная домашняя (с хлебом/мукой)',
    category: 'Мясо и рыба (0 ХЕ)',
    carbsPer100g: 10,
    gi: 'medium',
    defaultAmount: 100,
  ...
  {
    id: 'meat_cut_2',
    name: 'Котлета куриная (паровая, диетическая)',
    category: 'Мясо и рыба (0 ХЕ)',
    carbsPer100g: 5,
    gi: 'low',
    defaultAmount: 100,
  ...
  {
    id: 'meat_cut_4',
    name: 'Тефтели мясные с рисом (ежики)',
    category: 'Мясо и рыба (0 ХЕ)',
    carbsPer100g: 12,
    gi: 'medium',
    defaultAmount: 150,
  ...
  {
    id: 'b_mak_1',
    name: 'Плетенка с маком (домашняя сдобная)',
    category: 'Хлеб и выпечка',
    carbsPer100g: 53.0,
    gi: 'high',
    defaultAmount: 100,
  ...
  {
    id: 'ff_1',
    name: 'Бургер "Биг Мак" (1 шт = ~42г угл)',
    category: 'Фастфуд',
    carbsPer100g: 4200,
    unit: 'pcs',
    gi: 'high',
  ...
  {
    id: 'ff_2',
    name: 'Чизбургер стандартный (1 шт = ~29г угл)',
    category: 'Фастфуд',
    carbsPer100g: 2900,
    unit: 'pcs',
    gi: 'high',
  ...
  {
    id: 'ff_3',
    name: 'Наггетсы куриные (1 шт = ~3г угл)',
    category: 'Фастфуд',
    carbsPer100g: 300,
    unit: 'pcs',
    gi: 'high',
  ...
  {
    id: 'su_1',
    name: 'Ролл Филадельфия (1 шт = ~7г угл)',
  ...
  {
    id: 'su_2',
    name: 'Ролл Калифорния (1 шт = ~8г угл)',
    category: 'Суши и Роллы',
    carbsPer100g: 800,
    unit: 'pcs',
    gi: 'medium',
  ...
  {
    id: 'su_3',
    name: 'Суши / Нигири с рыбой (1 шт = ~5г угл)',
    category: 'Суши и Роллы',
    carbsPer100g: 500,
    unit: 'pcs',
    gi: 'medium',
  ...
  {
    id: 'sn_1',
    name: 'Батончик Snickers (1 шт, 50г = ~30г угл)',
  ...
  {
    id: 'sn_2',
    name: 'Батончик Twix (1 палочка = ~18г угл)',
    category: 'Снеки и Сладости',
    carbsPer100g: 1800,
    unit: 'pcs',
    gi: 'high',
  ...
  {
    id: 'sn_3',
    name: 'Чипсы картофельные (Lays и т.п.)',
    category: 'Снеки и Сладости',
    carbsPer100g: 53,
    gi: 'high',
    defaultAmount: 50,
  ...
  {
    id: 'sn_4',
    name: 'Попкорн сладкий (карамельный)',
    category: 'Снеки и Сладости',
    carbsPer100g: 78,
    gi: 'high',
    defaultAmount: 50,
  ...
  {
    id: 'shw_1',
    name: 'Шаурма / Денер с курицей (стандарт, 1 шт = ~45г угл)',
    category: 'Фастфуд',
    carbsPer100g: 4500,
    unit: 'pcs',
    gi: 'medium',
  ...
  {
    id: 'shw_2',
    name: 'Шаурма / Денер со свининой (стандарт, 1 шт = ~45г угл)',
    category: 'Фастфуд',
    carbsPer100g: 4500,
    unit: 'pcs',
    gi: 'medium',
  ...
  {
    id: 'shw_3',
    name: 'Шаурма / Денер с говядиной (стандарт, 1 шт = ~45г угл)',
    category: 'Фастфуд',
    carbsPer100g: 4500,
    unit: 'pcs',
    gi: 'medium',
  ...
  {
    id: 'shw_4',
    name: 'Шаурма с курицей (большая / XL, 1 шт = ~65г угл)',
    category: 'Фастфуд',
    carbsPer100g: 6500,
    unit: 'pcs',
    gi: 'medium',
  ...
  {
    id: 'shw_5',
    name: 'Шаурма со свининой (большая / XL, 1 шт = ~65г угл)',
    category: 'Фастфуд',
    carbsPer100g: 6500,
    unit: 'pcs',
    gi: 'medium',
  ...
  {
    id: 'shw_6',
    name: 'Шаурма с говядиной (большая / XL, 1 шт = ~65г угл)',
    category: 'Фастфуд',
    carbsPer100g: 6500,
    unit: 'pcs',
    gi: 'medium',
